...
public class CustomerController {
	...
	@ResponseBody
	public ResponseEntity addCustomer(@RequestBody @NonNull AddUpdateCustomerRequest addUpdateCustomerRequest) {

		AddUpdateCustomerResponse addUpdateCustomerResponse = customerService.addCustomer(addUpdateCustomerRequest);

		if (addUpdateCustomerResponse == null) {
			return getGetCustomerResponseEntity("Error adding a new Customer");
		}

		log.info("Successfully added Customer={} {} with  status={}", addUpdateCustomerRequest.getFirstName(),
				addUpdateCustomerRequest.getLastName(), addUpdateCustomerResponse.getStatus().name());
	...
	public ResponseEntity getCustomerById(@PathVariable @NonNull Long CustomerId) {
		...
		try {
			...
			log.info("Successfully found Customer={} {} with id={}", getCustomerResponse.getFirstName(),
					getCustomerResponse.getLastName(), CustomerId);
	...
	private ResponseEntity getGetCustomerResponseEntity(String errorMessage) {
